...
import { reqClient } from "../../api/user";
...
export default {
  ...
  data() {
    return {
      ...
      addFormRules: {
        ...
        keyman: [
          { required: true, message: "키맨을 입력해주세요", trigger: "blur" }
        ]
      },
      // 신규고객 입력정보
      addForm: {
  ...
  methods: {
    ...
    getUsers() {
      ...
      this.total = 1000;
      this.users = [
        {num: 1,name: "김고객",phone: "010-1111-2222",regDate: "2018-03-01",count: 10,payment: "1,000",keyman: "최키맨",memo: ""},
        {num: 2,name: "나고객",phone: "010-3333-4444",regDate: "2018-03-02",count: 8,payment: "20,000",keyman: "한키맨",memo: ""},
        {num: 3,name: "다고객",phone: "010-5555-6666",regDate: "2018-03-03",count: 20,payment: "100",keyman: "한키맨",memo: ""},
        {num: 4,name: "라고객",phone: "010-7777-8888",regDate: "2018-03-04",count: 0, payment: "",keyman: "강키맨",memo: ""},
      ];
